cmd_drivers/block/blk_legacy.o := arm-none-eabi-gcc -Wp,-MD,drivers/block/.blk_legacy.o.d  -nostdinc -isystem /usr/lib/gcc/arm-none-eabi/6.3.1/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(blk_legacy)"  -D"KBUILD_MODNAME=KBUILD_STR(blk_legacy)" -c -o drivers/block/blk_legacy.o drivers/block/blk_legacy.c

source_drivers/block/blk_legacy.o := drivers/block/blk_legacy.c

deps_drivers/block/blk_legacy.o := \
...
drivers/block/blk_legacy.o: $(deps_drivers/block/blk_legacy.o)
