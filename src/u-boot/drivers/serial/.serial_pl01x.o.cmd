cmd_drivers/serial/serial_pl01x.o := arm-none-eabi-gcc -Wp,-MD,drivers/serial/.serial_pl01x.o.d  -nostdinc -isystem /usr/lib/gcc/arm-none-eabi/6.3.1/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(serial_pl01x)"  -D"KBUILD_MODNAME=KBUILD_STR(serial_pl01x)" -c -o drivers/serial/serial_pl01x.o drivers/serial/serial_pl01x.c

source_drivers/serial/serial_pl01x.o := drivers/serial/serial_pl01x.c

deps_drivers/serial/serial_pl01x.o := \
    $(wildcard include/config/dm/serial.h) \
    $(wildcard include/config/pl01x/ports.h) \
    $(wildcard include/config/pl010/serial.h) \
    ...
    $(wildcard include/config/debug/uart/pl010.h) \
    $(wildcard include/config/debug/uart/pl011.h) \
    $(wildcard include/config/debug/uart/skip/init.h) \
  ...
  drivers/serial/serial_pl01x_internal.h \
    $(wildcard include/config/pl011/serial/rlcr.h) \

drivers/serial/serial_pl01x.o: $(deps_drivers/serial/serial_pl01x.o)
