cmd_drivers/mtd/cfi_flash.o := arm-none-eabi-gcc -Wp,-MD,drivers/mtd/.cfi_flash.o.d  -nostdinc -isystem /usr/lib/gcc/arm-none-eabi/6.3.1/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(cfi_flash)"  -D"KBUILD_MODNAME=KBUILD_STR(cfi_flash)" -c -o drivers/mtd/cfi_flash.o drivers/mtd/cfi_flash.c

source_drivers/mtd/cfi_flash.o := drivers/mtd/cfi_flash.c

deps_drivers/mtd/cfi_flash.o := \
    $(wildcard include/config/sys/write/swapped/data.h) \
    ...
    $(wildcard include/config/sys/flash/banks/sizes.h) \
    ...
    $(wildcard include/config/sys/low/res/timer.h) \
